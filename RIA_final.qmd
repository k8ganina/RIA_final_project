...
## Overview
```{r}
table_tradit <- huxreg("with proxies" = fit_ols1,
                       "with real GDP" = fit_ols2,
  ...
  insert_row("","(1.1) OLS", "(1.2) OLS", "(2) OLS", "(3) OLS", "(4) PPML", after = 0) %>%
  insert_row(c("Fixed Effects", "No", "No", "No", "Yes", "Yes"), after = 33) %>%
