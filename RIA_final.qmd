...
#Weird results for the log of remoteness(??)
...
#When I run it I got "All observations contain NAs. Estimation cannot be done. Check whether you know how to fix it.
```
