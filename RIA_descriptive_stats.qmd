...
fig_1 <- ggplot(trade_japan, aes(x = year, y = total_trade/1000000)) +
  ...
  labs(title = "Figure 1: Japan's total level of trade from 1965 to 2020 \n(in thousands of current USD)", x = "Year", y = "Total trade (in million)") +
  theme_bw() +
...
fig_2 <- ggplot() +
  ...
  geom_vline(xintercept = 2008, linetype = "dashed", color = "red") +
  labs(title = "Figure 2: Japan's imports and exports from 1965 to 2020 \n(in thousands of current USD)", x = "Year", y = "Total amount of imports and exports \n(in million)") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_x_continuous(breaks = seq(1968, 2018, 10), limits = c(1965, 2020)) +
...
fig_3 <- ggplot(total_trade_ajcep, aes(x = year)) +
  ...
  labs(x = "Year", y = "Total Trade (in millions)", title = "Figure 3: AJCEP member states' total trade from 1965 to 2020 \n(in thousands of current USD)") +
  theme_bw() +
  geom_vline(xintercept = 2008, linetype = "dashed", color = "red") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_x_continuous(breaks = seq(1968, 2018, 10), limits = c(1965, 2020))
...
fig_4 <- ggplot(total_imports_ajcep, aes(x = year)) +
  ...
  scale_color_brewer(name="Legend", palette = "Paired") +
  labs(x = "Year", y = "Total imports (in millions)", title = "Figure 4: AJCEP member states' total imports from 1965 to 2020 \n(in thousands of current USD)") +
  theme_bw() +
  geom_vline(xintercept = 2008, linetype = "dashed", color = "red") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_x_continuous(breaks = seq(1968, 2018, 10), limits = c(1965, 2020))
...
fig_5 <- ggplot(total_exports_ajcep, aes(x = year)) +
  ...
  scale_color_brewer(name="Legend", palette = "Paired") +
  labs(x = "Year", y = "Total exports (in millions)", title = "Figure 5: AJCEP member states' total exports from 1965 to 2020 \n(in thousands of current USD)") +
  theme_bw() +
  geom_vline(xintercept = 2008, linetype = "dashed", color = "red") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_x_continuous(breaks = seq(1968, 2018, 10), limits = c(1965, 2020))
...
fig_8 <- ggplot(top_exports_2000_sum, aes(x = "", y = share_japan_exports, fill = iso3_d)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 8: Main export destinations of Japan in 2000", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
...
fig_9 <- ggplot(top_exports_2012_sum, aes(x = "", y = share_japan_exports, fill = iso3_d)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 9: Main export destinations of Japan in 2012", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
  geom_text(aes(label = paste0(round(share_japan_exports, 2), "%")), 
            position = position_stack(vjust = 0.5), size = 3.5) +
