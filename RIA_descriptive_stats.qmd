...
png("./fig_1.png", width=600, height=400)
print(fig_1)
dev.off()
```
...
png("./fig_2.png", width=600, height=400)
print(fig_2)
dev.off()
```
...
png("./fig_3.png", width=600, height=400)
print(fig_3)
dev.off()
```
...
fig_4 <- ggplot(total_imports_ajcep, aes(x = year)) +
...
png("./fig_4.png", width=600, height=400)
print(fig_4)
dev.off()
```
...
fig_5 <- ggplot(total_exports_ajcep, aes(x = year)) +
...
png("./fig_5.png", width=600, height=400)
print(fig_5)
dev.off()
```
...
table_1_exports <- as_hux(japan_exports) %>%
  set_caption("Table 1: Japan level of export to each ASEAN country in 2000 and 2012\n") %>%
  ...
  set_font_size(7.5) %>%
  set_label("table_1_exports")

table_1_exports

table_2_imports <- as_hux(japan_imports) %>%
  set_caption("Table 2: Japan level of import from each ASEAN country in 2000 and 2012\n") %>%
  set_align(everywhere,-1,"center") %>%
  set_top_border(2, everywhere) %>%
  set_right_border(everywhere, 1) %>%
  set_bottom_border(3, everywhere) %>%
  ...
  set_number_format(-1, -1, fmt_pretty(digits=1)) %>%
  set_font_size(7.5) %>%
  set_label("table_2_imports")

table_2_imports

width(table_1_exports) = 1.35
width(table_2_imports) = 1.35

# Export the tables to word

table_1_exports_docx = as_flextable(table_1_exports)
save_as_docx(table_1_exports_docx, path = "table_1_exports.docx")

table_2_imports_docx = as_flextable(table_2_imports)
save_as_docx(table_2_imports_docx, path = "table_2_imports.docx")
```
...
fig_6 <- ggplot(top_imports_2000_sum, aes(x = "", y = share_japan_imports, fill = iso3_o)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 6: Main exporters to Japan in 2000", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
  geom_text(aes(label = paste0(round(share_japan_imports, 2), "%")), 
            position = position_stack(vjust = 0.5), size = 3.5) +
  scale_fill_manual(name = "Country", values = brewer.pal(6, "Paired"),
...
fig_7 <- ggplot(top_imports_2012_sum, aes(x = "", y = share_japan_imports, fill = iso3_o)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 7: Main exporters to Japan in 2012", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
  geom_text(aes(label = paste0(round(share_japan_imports, 2), "%")), 
            position = position_stack(vjust = 0.5), size = 3.5) +
...
fig_8 <- ggplot(top_exports_2000_sum, aes(x = "", y = share_japan_exports, fill = iso3_d)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 8: Main exports destinations of Japan in 2000", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
...
fig_9 <- ggplot(top_exports_2012_sum, aes(x = "", y = share_japan_exports, fill = iso3_d)) + 
  geom_bar(width = 1, stat = "identity") +
  coord_polar(theta = "y") +
  labs(title = "Figure 9: Main exports destinations of Japan in 2012", fill = "Country", x = NULL, y = NULL) +
  theme_void() +
  theme(legend.position = "left") +
  geom_text(aes(label = paste0(round(share_japan_exports, 2), "%")), 
            position = position_stack(vjust = 0.5), size = 3.5) +
